...
class GameOfLifeTest {
	...
	@Test
	void getListOfSamePositionAppearingTwice() {
		Position p1 = new Position(2, 6);
		assertEquals(
			List.of(p1, p1),
			GameOfLife.getBounds(List.of(p1))
		);
	}
	
	@Test
	void givenTwoPointReturnWithBothPointInSpecifiedOrder() {
		Position p1 = new Position(2, 6);
		Position p2 = new Position(4, 8);
		assertEquals(
			List.of(p1, p2),
			GameOfLife.getBounds(List.of(p2, p1))
		);
	}
	
	@Test
	void givenThreePointReturnWithBothPointInSpecifiedOrder() {
		Position p1 = new Position(0, 0);
		Position p2 = new Position(3, 4);
		Position p3 = new Position(4, 3);
		assertEquals(
			List.of(p1, new Position(4, 4)),
			GameOfLife.getBounds(List.of(p1, p2, p3))
		);
	}
	
	@Test
	void givenFourPointReturnWithBothPointInSpecifiedOrder() {
		Position p1 = new Position(2, 5);
		Position p2 = new Position(4, 3);
		Position p3 = new Position(3, 4);
		Position p4 = new Position(8, 1);
		assertEquals(
			List.of(new Position(2, 1), new Position(8, 5)),
			GameOfLife.getBounds(List.of(p1, p2, p3, p4))
		);
	}
